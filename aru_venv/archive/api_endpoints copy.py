...
from models import engine, Base, Session, Departments, Users, Author, Category, Citingpaper, Research, Fileupload, Status, Incentivesapplication, Notification, Authorresearch, Researchciting
from flask_cors import CORS
...
def deleteUser():
    ...
    try:
        db_author = session.get(Author,data.get('author_id'))
        db_user = session.get(Users,data.get('user_id'))
